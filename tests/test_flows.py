...
from src.nodes.examples import GreetingNode, RandomNumberNode, DataTransformNode
...
class TestFlowExecution:
    ...
    def test_flow_with_initial_store(self):
        ...
        assert "InitialUser" in result["name"] or result["name"] == "Initialuser"  # Handle name normalization
...
class TestFlowErrorHandling:
    ...
    def test_node_error_handling(self):
        ...
        assert result["error_node"] == "start" or "ErrorNode" in str(result.get("error_node", ""))
